...
//Create Doubly linked list class for undo/redo functionality
class UndoRedoManager {
    ...
    //Create method  Add a new text state
    ...
    //Create method  Undo functionality
    public void undo() {
    ...
    //Create method  Redo functionality
    public void redo() {
    ...
    //Create method  Display the current state of the text
